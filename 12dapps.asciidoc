...
You can find the user interface code in the _code/auction_dapp/frontend_ folder in https://github.com/landoyjx/ethereumbook[the book's repository]. The directory has the following structure and contents:
